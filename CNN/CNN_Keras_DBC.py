...
img18_PATH = "C:\\Git\\T-Friend\\img_data_18"
img17_PATH = "C:\\Git\\T-Friend\\img_data_17"
img_combine_PATH = "C:\\Git\\T-Friend\\img_data_combine"
...
trX, trY, result = data_set_fun(img_PATH, 0, 0)#train_img_new
#print('train_분포 : ', result)
teX, teY, result = data_set_fun(img_PATH, 0, 0)#test_img_new
...
'''
history = model.fit(trX, trY, validation_split=0.3, epochs=EPOCH, batch_size=BATCH_SIZE, shuffle=True, verbose=VERBOSE)

FILE_NAME = 'model_complete1.h5'
