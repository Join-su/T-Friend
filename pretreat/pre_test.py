...
excel_file = excel.Workbooks.Open('C:\\Users\\ialab\\PycharmProjects\\insu_CNN\\train_test18.xlsx')
...
for i in range(2,99999):
    ...
    encoded_image_path = text_to_image.encode(st1+st2, "C:\\Users\\ialab\\PycharmProjects\\insu_CNN\\img_17_18_2\\a_%d_%d.png" %(test,de)) #이미지로 인코딩
